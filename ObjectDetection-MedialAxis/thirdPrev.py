...
while(1):
    ...
    lines = cv2.HoughLines(edges,1,np.pi/180,170) # last param is the threshold
    ...
    # these variables are to be globalized to retain the previous values of rho and theta but that will be differ coz object is moving
    # thetaG = 0
    # rhomin = 0
    # rhomax = 0
